...

{
    ...
    if ($mod == "del") {
        $q_delete_inbox = mysqli_query($mysqli,"DELETE FROM inbox_spam WHERE ID = '$id_inbox'");
        if ($q_delete_inbox >0) {
    ...
    if ($mod == "delall") {
        $q_deleteall_inbox = mysqli_query($mysqli,"DELETE FROM inbox_spam");
            ...
            <div class="content-panel">
                <section id="unseen">
                    ...
                    <div class="weather-2">
                        ...
                        <a class="btn btn-danger" href="?id=inboxspam&mod=delall" onclick="return confirm ('Menghapus semua pesan?')">Hapus all</a>

                        <a href="?id=inboxspam" class="btn btn-success ">

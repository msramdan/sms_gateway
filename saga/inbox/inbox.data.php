...
<tbody>
    <?php 
        ...
        $jml_data = mysqli_num_rows(mysqli_query($mysqli,"SELECT a.ID,a.ReceivingDateTime,a.SenderNumber,a.TextDecoded,b.Name as nmpengirim from inbox a 
        ...
        if(isset($_POST['cari'])) {
            ...
            $query = mysqli_query($mysqli,"
              SELECT a.ID,a.ReceivingDateTime,a.SenderNumber,a.TextDecoded,b.Name as nmpengirim from inbox a 
                left join pbk b on a.SenderNumber=b.Number
        ...
        // query jika nomor halaman sudah ditentukan
            ...
            $query = mysqli_query($mysqli,"SELECT a.ID,a.ReceivingDateTime,a.SenderNumber,a.TextDecoded,b.Name as nmpengirim from inbox a 

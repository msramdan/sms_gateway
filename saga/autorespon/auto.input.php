...
if(isset($_POST['hapus'])) {
	mysqli_query($mysqli,"DELETE FROM tbl_autorespon WHERE id=".$_POST['hapus']);
} else {
    ...
    $no_forward = $_POST['no_forward'];

	// validasi agar tidak ada data yang kosong
	if($keyword1!=""||$keyword2!="") {
		// proses tambah data
		if($id_auto == 0) {
			mysqli_query($mysqli,"INSERT INTO tbl_autorespon VALUES('','$keyword1','$keyword2','$result1','$idforward','$no_forward')");
		// proses ubah data
		} else {
			$q_auto=mysqli_query($mysqli,"UPDATE tbl_autorespon SET
			keyword1 = '$keyword1',
			keyword2 = '$keyword2',
			result = '$result1',
			idforward 	= $idforward,

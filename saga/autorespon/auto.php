            ...
            <div class="content-panel">
                <section id="unseen">
                    ...
                    <div class="weather-2">
                        ...
                        <a href="?id=autorespon" class="btn btn-success ">
                            <i class="fa fa-refresh bigger-160"></i>
                            Refresh
                        </a>
                        <p> &nbsp Contoh Format SMS Autorespon Ketik : REG(spasi)SAGA</p>
                    </div>
                    </thead>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i id="myModalLabel">Autorespon</i></h4>
                </div>

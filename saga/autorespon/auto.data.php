...
<thead>
    <tr>
        ...
        <th class="site-footer">AutoForward</th>
        <th class="site-footer">No Forward</th>
...
<tbody>
    <?php 
        ...
        $jml_data = mysqli_num_rows(mysqli_query($mysqli,"SELECT * FROM tbl_autorespon order by id desc"));
        ...
        if(isset($_POST['cari'])) {
            ...
            $query = mysqli_query($mysqli,"
                SELECT * FROM tbl_autorespon
                WHERE keyword1 LIKE '%$kunci%'
                OR keyword2 LIKE '%$kunci%'
                OR no_forward LIKE '%$kunci%'
        ...
        // query jika nomor halaman sudah ditentukan
            ...
            $query = mysqli_query($mysqli,"SELECT * FROM tbl_autorespon order by id desc LIMIT ".(($halaman - 1) * $jml_per_halaman).", $jml_per_halaman");
        // query ketika tidak ada parameter halaman maupun pencarian
        } else {
            $query = mysqli_query($mysqli,"SELECT * FROM tbl_autorespon order by id desc  LIMIT 0, $jml_per_halaman");
            $halaman = 1; //tambahan
        }
    ...
    <tr>
        ...
        <td><?php 
            ...
            ?></td>
        <td><?php echo $data['no_forward']  ?></td>

						...
						<form name="myForm" id="myForm"  class="form-horizontal" onSubmit="return validateForm()" action="#" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<div class="col-sm-9">
									...
									<a href="importsmstemplate.xls" class="btn btn-success btn-sm btn-next">Download</a>  Contoh format Excel
									 <a href="?id=smsimport" class="btn btn-warning"><i class="fa fa-refresh"></i>Refresh</a>
								</div>
							</div>
						</form>
					</div>
...
if(isset($_POST['submit'])){
    ...
    for ($i=2; $i<=$baris; $i++)
    {
        ...
        $query = "INSERT INTO outbox (DestinationNumber, TextDecoded, CreatorID) VALUES ('$nohp', '$isisms', 'Gammu')";
        ...
        document.getElementById("info").innerHTML="<div class=\'alert alert-info\'>'.$k.' data berhasil diimport ('.$percent.' selesai).</div>";
        </script>';

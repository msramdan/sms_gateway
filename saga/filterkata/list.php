            ...
            <div class="content-panel">
                <section id="unseen">
                    ...
                    <div class="weather-2">
                        ...
                        <a  data-target="#dialog-group" id="0" class="tambahkata btn btn-info" data-toggle="modal" >
                            <i class="fa fa-pencil-square-o"></i>
                            Tambah
                            <span class="badge badge-warning badge-right"></span>
                        </a>

                        <a href="?id=filterkata" class="btn btn-success ">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i id="myModalLabel">Form </i></h4>
                </div>

                <div class="modal-body">
                    <div class="filterkata"></div>
                </div>

                <div class="modal-footer">
                    <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">Batal</button>
                    <button id="simpan-kata" class="btn btn-success" data-dismiss="collapse" aria-hidden="true" >Simpan</button>
                </div>
            </div>
        </div>
    </div>

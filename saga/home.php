    ...
    <div class="col-lg-9 main-chart">
        ...
        <div class="row mtbox">
            <div class="col-md-2 col-sm-2 col-md-offset-1 box0">
                <div class="box1">
					...
					<?php 
					$v_inbox=mysqli_query($mysqli,"select count(*) as jum from inbox");
					$Vh_inbox=mysqli_fetch_array($v_inbox);
					$jum=$Vh_inbox['jum'];
					
					echo "
					 <div class='label label-danger'>$jum Kotak Masuk </div>
					";
            ...
            <div class="col-md-2 col-sm-2 box0">
                <div class="box1">
                    ...
                    <div class="label label-danger">Pesan Siaran</div>
                </div>
            ...
            <div class="col-md-2 col-sm-2 box0">
                <div class="box1">
                    ...
                    <div class="label label-danger">Pesan Terkirim</div>
                </div>
            ...
            <div class="col-md-2 col-sm-2 box0">
                <div class="box1">
                    ...
                    <?php 
                     $viewphone=mysqli_query($mysqli,"select * from phones");
                     $rowphone=mysqli_fetch_array($viewphone);
                    ?>
                    <div class="label label-danger"><?php echo $rowphone['Signal'];?>% Sinyal Modem</div>
        ...
        <div class="row mt">
            ...
            <div class="custom-bar-chart">
                ...
                <?php
				$tahun=date("Y");
                $total = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox where YEAR(ReceivingDateTime)='$tahun'");
                $data = mysqli_fetch_row($total);
                $totalall = $data[0];

                $hasil1 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='01' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil2 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='02' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil3 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='03' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil4 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='04' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil5 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='05' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil6 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='06' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil7 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='07' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil8 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='08' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil9 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='09' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil10 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='10' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil11 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='11' and YEAR(ReceivingDateTime)='$tahun'");
                ...
                $hasil12 = mysqli_query($mysqli,"SELECT count(*) as jum FROM inbox WHERE MONTH(ReceivingDateTime)='12' and YEAR(ReceivingDateTime)='$tahun'");

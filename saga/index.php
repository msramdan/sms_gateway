...
<html lang="en">
  <head>
    ...
    <title>SAGA - SMS ANDEZNET GATEWAY</title>
	  ...
	  <div id="login-page">
	  	<div class="container">
				...
				<form name="form" id="loginF" method="post" action="" class="form-login">
				 <h2 class="form-login-heading">Login SAGA</h2>
				 <div id="loading" style="text-align: center"></div>
					...
					<div class="form-group">
                        <div class="col-sm-12">
		            <button class="btn  btn-block btn-default"><i class="fa fa-lock"></i> LOGIN</button>
                            </div>
					</div>
		            ...
		            <div class="registration">
		                ...
		                <br>Untuk membuat account klik dibawah ini<br/>
		                <a href="register.php">
		                    Buat Account ?
		                </a>
		            </div>
                    ...
                    <footer class="site-footer">
                        <div class="text-center">
                            2018 <a href="http://andeznet.com"><b>AndezNet</b></a>
                        </div>
                    </footer>
				 </form>	 
		        </div>
